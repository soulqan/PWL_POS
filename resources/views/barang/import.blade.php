    ...
    $(document).ready(function () {
        $("#form-import").validate({
            ...
            submitHandler: function (form) {
                var formData = new FormData(form); // Ubah form menjadi FormData untuk handle file

                $.ajax({
                    url: form.action,
                    type: form.method,
                    data: formData,
                    processData: false, // Jangan diproses (karena FormData)
                    contentType: false, // Jangan set content-type (biar otomatis)
